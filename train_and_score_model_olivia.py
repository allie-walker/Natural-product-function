...
training_set_dir = "feature_matrices/fungal/"
...
training_set_name = "fungal_training"
...
for classification in classifications:
    ...
    print(best_tree.n_features_in_)
    print(best_log.n_features_in_)  
