...
try:    
    ...
    if antismash_version == 4:  
        training_pfam_features = readFeatureFiles.readFeatureMatrix("feature_matrices/PFAM5.csv")
        training_smCOG_features = readFeatureFiles.readFeatureMatrix("feature_matrices/SMCOG5.csv")
        ...
        training_pfam_features = readFeatureFiles.readFeatureMatrix("/data/walker_Lab/olivia_riedling/fungal_train/training_set/gene_feature_matrices/features/PFAM5.csv")
        training_smCOG_features = readFeatureFiles.readFeatureMatrix("/data/walker_Lab/olivia_riedling/fungal_train/training_set/gene_feature_matrices/features/SMCOG5.csv")
        training_CDS_features = readFeatureFiles.readFeatureMatrix("/data/walker_Lab/olivia_riedling/fungal_train/training_set/gene_feature_matrices/features/CDS_motifs5.csv")        
        training_pk_consensus_features = readFeatureFiles.readFeatureMatrix("/data/walker_Lab/olivia_riedling/fungal_train/training_set/gene_feature_matrices/features/pk_nrp_consensus5.csv")
        print(training_pk_consensus_features)
    ...
    if rgi_version == 3:
        ...
        training_card_features = readFeatureFiles.readFeatureMatrix("/data/walker_Lab/olivia_riedling/fungal_train/training_set/gene_feature_matrices/features/CARD5_genes.csv")
        used_resistance_genes_list = readFeatureFiles.readFeatureList("/data/walker_Lab/olivia_riedling/fungal_train/training_set/gene_feature_matrices/features/CARD5_genes_list.txt")
        print(used_resistance_genes_list)
    is_antibacterial = readFeatureFiles.readClassesMatrix("/data/walker_Lab/olivia_riedling/fungal_train/training_set/gene_feature_matrices/classifications/is_antibacterial.csv")
    is_antifungal = readFeatureFiles.readClassesMatrix("/data/walker_Lab/olivia_riedling/fungal_train/training_set/gene_feature_matrices/classifications/is_antifungal.csv")
    is_cytotoxic = readFeatureFiles.readClassesMatrix("/data/walker_Lab/olivia_riedling/fungal_train/training_set/gene_feature_matrices/classifications/is_cytotoxic.csv")
    is_unknown = readFeatureFiles.readClassesMatrix("/data/walker_Lab/olivia_riedling/fungal_train/training_set/gene_feature_matrices/classifications/is_unknown.csv")
    targets_gram_pos = readFeatureFiles.readClassesMatrix("/data/walker_Lab/olivia_riedling/fungal_train/training_set/gene_feature_matrices/classifications/targets_gram_pos.csv")
    targets_gram_neg = readFeatureFiles.readClassesMatrix("/data/walker_Lab/olivia_riedling/fungal_train/training_set/gene_feature_matrices/classifications/targets_gram_neg.csv")
    full_cluster_list = readFeatureFiles.readClusterList("/data/walker_Lab/olivia_riedling/fungal_train/training_set/gene_feature_matrices/cluster_list.txt")
...
#Pretrained model load in 
#antibacterial predictions
svm_params = {"kernel":'rbf',"C":10,"gamma":0.1}
tree_params = {"depth":100,"n":50}
log_params = {"l1_ratio":.05,"alpha":.01}

if antismash_version == 5 and rgi_version == 5:
    svm_bacterial, tree_bacterial, log_bacterial = joblib.load("/data/walker_Lab/olivia_riedling/fungal_train/training_set/trained_models/fungal_training_antibacterial.sav")
    ...
    #print(svm_bacterial_prob)
    #print(tree_bacterial_prob)
    #print(log_bacterial_prob)
else:
